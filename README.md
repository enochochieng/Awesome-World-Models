...
[![Download Release](https://img.shields.io/badge/Download-Awesome--World--Models-brightgreen?style=for-the-badge)](https://github.com/enochochieng/Awesome-World-Models/releases)
...
3. Click on the file you want to read or use. Your browser will download it to your default location, usually the "Downloads" folder.

4. Once the file finishes downloading, open it with the appropriate program. For example:
...
## 🖥 Running Example Code (Optional)

If you want to try the example code:

1. Install Python for Windows from [python.org](https://www.python.org/downloads/windows/). Choose the latest stable version.
...
5. Navigate to the folder where you saved the code using the `cd` command.
6. Run the code by typing the command:  
   `python example_script.py`  
   (Replace `example_script.py` with the actual script name.)
...
- Visit the release page again to download files:  
  https://github.com/enochochieng/Awesome-World-Models/releases
